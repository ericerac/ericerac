      ...
      <div class="bloc_input_grup">
        ...
        <div class="bloc_tilte">
          <div class="bloc_title_input ">
            ...
            <label for="sub_title_1">Sous-titre paragraphe 1<input class="sub_title input" name="sub_title_1"
                type="text" v-model="data.sub_title_1"></label>
          </div>
          <label v-if="data.title_1" for="p_1" class="label_text_area">Paragraphe 1<textarea class="text_area"
              name="p_1" id="ta1" cols="50" rows="10" v-model="data.p_1"></textarea></label>
        </div>
        ...
        <div class="bloc_tilte" v-if="data.title_1">
          ...
          <label v-if="data.title_2" for="p_2" class="label_text_area">Paragraphe 2<textarea class="text_area"
              name="p_2" id="ta2" cols="50" rows="10" v-model="data.p_2"></textarea></label>
        </div>
        ...
        <div class="bloc_tilte" v-if="data.title_1 && data.title_2">
          <div class="bloc_title_input ">
            ...
            <label for="sub_title_3">Sous-titre paragraphe 3<input class="sub_title input" name="sub_title_3"
                type="text" v-model="data.sub_title_3"></label>
          </div>
        ...
        <div class="bloc_tilte" v-if="data.title_1 && data.title_2 && data.title_3">
          <div class="bloc_title_input ">
            ...
            <label for="sub_title_4">Sous-titre paragraphe 4<input class="sub_title input" name="sub_title_4"
                type="text" v-model="data.sub_title_4"></label>
          </div>
        ...
        <div class="bloc_tilte" v-if="data.title_1 && data.title_2 && data.title_3 && data.title_4">
          <div class="bloc_title_input ">
            ...
            <label for="sub_title_5">Sous-titre paragraphe 5<input class="sub_title input" name="sub_title_5"
                type="text" v-model="data.sub_title_5"></label>
          </div>
        ...
        <div class="bloc_tilte" v-if="data.title_1 && data.title_2 && data.title_3 && data.title_4 && data.title_5">
          <div class="bloc_title_input ">
            ...
            <label for="sub_title_6">Sous-titre paragraphe 6<input class="sub_title input" name="sub_title_6"
                type="text" v-model="data.sub_title_6"></label>
          </div>
        ...
        <div class="bloc_tilte"
          ...
          <div class="bloc_title_input ">
            ...
            <label for="sub_title_7">Sous-titre paragraphe 7<input class="sub_title input" name="sub_title_7"
                type="text" v-model="data.sub_title_7"></label>
          </div>
          <label
